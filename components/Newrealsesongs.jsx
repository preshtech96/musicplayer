...
const Newrealsesongs = () => {
  return (
    <div className='pb-20'>
          <h1 className="text-3xl sm:text-4xl md:text-5xl  font-bold  pl-10 pt-10 pb-10 text-white">New Release<span className="text-pink-600">Songs</span></h1>
