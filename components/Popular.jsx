    ...
    return (
        <div className="pb-10 px-4 sm:px-10 ">
                        ...
                        <tr className="text-center text-xs sm:text-sm ">
                            ...
                            <td className="px-2 sm:px-4 py-2">
                                <div className="flex items-center justify-center gap-1 sm:gap-2 text-white">
                                    <button onClick={() => setLiked(!liked)} className="focus:outline-none cursor-pointer">
                                        {liked ? <AiFillHeart className="text-red-500 h-5 w-5" /> : <AiOutlineHeart className="h-5 w-5" />}
                                    </button>
                                    <span>2.9</span>
                                </div>
                            </td>
            ...
            <div className='flex flex-row gap-5 justify-center items-center '>
                <button className='text-white cursor-pointer flex flex-row gap-2 bg-pink-500 p-2 rounded-[5px]'>
